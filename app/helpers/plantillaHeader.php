                      ...
                      <ul class="navbar-nav me-auto mb-2 mb-lg-0 d-flex">
                          <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  ...
                                  <li><a class="dropdown-item" href="index.php #beneficios">Benieficios</a></li>
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <li><a class="dropdown-item" href="#">Desarollo de java</a></li>
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <li><a class="dropdown-item" href="#">Chats en vivo basados en web</a></li>
                                  <li><a class="dropdown-item" href="#">Software chat-im</a></li>
                              </ul>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link active" aria-current="page" href="desarollo.php">Desarollo</a>
                          </li>
                          <li class="nav-item">
